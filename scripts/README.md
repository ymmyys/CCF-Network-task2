...
8×7B 现场演示使用 `yijq27-vllm-qwen7b-0..7`，端口为 `9118/9119/9120/9121/9122/9126/9127/9128`，Router 配置为 `config/router.qwen7b-8backends-p2c.json`。既有 exp8 脚本仍默认使用 NPU3-7，不自动占用 NPU0-2。
